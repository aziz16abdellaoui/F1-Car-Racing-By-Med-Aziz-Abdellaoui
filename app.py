...
class App:
    def __init__(self, settings):
        ...
        self.window.set_caption("F1 race By Med Aziz Abdellaoui")
    ...
    def check_race_completion(self):
        for car in self.simulation.cars:
            if car.laps >= 44:
                print(f"Race completed by a car after {car.laps} laps.")
                return True
        return False
...
if __name__ == "__main__":
    ...
    entity = Entity(name="F1 Racer")
    app = App(settings)
    app.start_simulation(entity)
