...
# car images and drivers
racers_info = {
    "alfaromeo" : ["alfaromeo.png", (0,0,0,255), ["Valtteri Bottas", "Zhou Guanyu"]],
    "alphatauri" : ["alphatauri.png",(0,0,170,255), ["Yuki Tsunoda", "Nyck de Vries"]],
    "alpine" : ["alpine.png",(52,205,243,255), ["Esteban Ocon", "Pierre Gasly"]],
    "astonmartin" : ["astonmartin.png",(10,183,45,255), ["Fernando Alonso", "Lance Stroll"]],
    "ferrari" : ["ferrari.png",(150,150,150,255), ["Charles Leclerc", "Carlos Sainz"]],
    "haas": ["haas.png",(231,132,0,255), ["Kevin Magnussen", "Nico Hulkenberg"]],
    "mclaren": ["mclaren.png",(203,0,0,255), ["Lando Norris", "Oscar Piastri"]],
    "mercedes": ["mercedes.png",(250,56,178,255), ["Lewis Hamilton", "George Russell"]],
    "redbull": ["redbull.png",(228,229,0,255), ["Max Verstappen", "Sergio Perez"]],
    "williams": ["williams.png",(255,255,255,255), ["Alex Albon", "Logan Sargeant"]]
}
...
class CarLabel:
    def __init__(self, order=1, team="", driver_index=0, height=24, width=43, margin=25, batch=None):
        self.x = 0
        self.y = 0
        ...
        self.labels_init_dict = {
            ...
            "name": [racers_info[team][2][driver_index],"Comfortaa", True, 12, (255, 255, 255, 255), (5, m), "left"],
        }
